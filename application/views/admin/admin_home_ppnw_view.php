                        ...
                        <div class="part1">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="order_id" id="order_id" placeholder="Order ID" required readonly="readonly">
                                </div>
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="part1 row">
                        ...
                        <div class="col-md-2 ">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="order_date" id="order_date" placeholder="Date" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-md-offset-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="order_company" id="order_company" placeholder="Order Company" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="order_item_name" id="order_item_name"  placeholder="Order Item Name" required>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="order_ref_no">Reference No.:</label>
                                <input type="text" class="form-control" name="order_ref_no" id="order_ref_no" placeholder="Order Reference No." required>
                            </div>
                        </div>
                            ...
                            <div class="part3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="order_body_h_total" name="order_body_h_total" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_body_w_total" name="order_body_w_total" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_body_panel_total" name="order_body_panel_total"  readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_handle_l_total" name="order_handle_l_total" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_handle_w_total" name="order_handle_w_total" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_pocket_l_total" name="order_pocket_l_total" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_pocket_w_total" name="order_pocket_w_total" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_extra_1_l_total" name="order_extra_1_l_total"  readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_extra_1_w_total" name="order_extra_1_w_total" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_extra_2_l_total" name="order_extra_2_l_total"  readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_extra_2_w_total" name="order_extra_2_w_total" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_extra_3_l_total" name="order_extra_3_l_total" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="order_body">Total:</label>
                                            <input type="text" class="form-control" id="order_extra_3_w_total" name="order_extra_3_w_total"  readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <article class="row part3">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr class="success">
                                    ...
                                    <td>Kg</td>
                                    <td><input type="text" class="form-control" id="ppnw_consumption" name="ppnw_consumption" readonly="readonly"></td>
                                    <td><input type="text" class="form-control" id="ppnw_consumption_rate" name="ppnw_consumption_rate" readonly="readonly"></td>
                                    <td>SQM</td>
                                    <td><input type="text" class="form-control" id="ppnw_consumption_cost" name="ppnw_consumption_cost" readonly="readonly"></td>
                                </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr class="danger">
                                    ...
                                    <td><input type="text" class="form-control" id="zipper_consumption_rate" name="zipper_consumption_rate" readonly="readonly"></td>
                                    <td>Metre</td>
                                    <td><input type="text" class="form-control" id="zipper_consumption_cost" name="zipper_consumption_cost" readonly="readonly"></td>
                                </tr>
                                <tr class="danger">
                                    <td>Webbing</td>
                                    ...
                                    <td><input type="text" class="form-control" id="webbing_consumption_rate" name="webbing_consumption_rate" readonly="readonly"></td>
                                    <td>Metre</td>
                                    <td><input type="text" class="form-control" id="webbing_consumption_cost" name="webbing_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="danger">
                                    ...
                                    <td><input type="text" class="form-control" id="draw_string_consumption_rate" name="draw_string_consumption_rate" readonly="readonly"></td>
                                    <td>Metre</td>
                                    <td><input type="text" class="form-control" id="draw_string_consumption_cost" name="draw_string_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="danger">
                                    ...
                                    <td><input type="text" class="form-control" id="velcro_consumption_rate" name="velcro_consumption_rate" readonly="readonly"></td>
                                    <td>Metre</td>
                                    <td><input type="text" class="form-control" id="velcro_consumption_cost" name="velcro_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="danger">
                                    ...
                                    <td><input type="text" class="form-control" id="tape_consumption_rate" name="tape_consumption_rate" readonly="readonly"></td>
                                    <td>Metre</td>
                                    <td><input type="text" class="form-control" id="tape_consumption_cost" name="tape_consumption_cost"  readonly="readonly"></td>
                                </tr>

                                <tr class="danger">
                                    <td>Extra 1</td>
                                    <td><input type="text" class="form-control" id="extra_trim_yard_1_cost" name="extra_trim_yard_1_cost" ></td>
                                    <td>Yard</td>
                                    <td><input type="text" class="form-control" id="extra_trim_yard_1_consumption" name="extra_trim_yard_1_consumption" ></td>
                                    <td><input type="text" class="form-control" id="extra_trim_yard_1_consumption_rate" name="extra_trim_yard_1_consumption_rate" readonly="readonly"></td>
                                    <td>Metre</td>
                                    <td><input type="text" class="form-control" id="extra_trim_yard_1_consumption_cost" name="extra_trim_yard_1_consumption_cost" readonly="readonly"></td>
                                </tr>

                                <tr class="danger">
                                    <td>Extra 2</td>
                                    <td><input type="text" class="form-control" id="extra_trim_yard_2_cost" name="extra_trim_yard_2_cost" ></td>
                                    <td>Yard</td>
                                    <td><input type="text" class="form-control" id="extra_trim_yard_2_consumption" name="extra_trim_yard_2_consumption" ></td>
                                    <td><input type="text" class="form-control" id="extra_trim_yard_2_consumption_rate" name="extra_trim_yard_2_consumption_rate" readonly="readonly"></td>
                                    <td>Metre</td>
                                    <td><input type="text" class="form-control" id="extra_trim_yard_2_consumption_cost" name="extra_trim_yard_2_consumption_cost" readonly="readonly"></td>
                                </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="puller_consumption_rate" name="puller_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="puller_consumption_cost" name="puller_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="print_consumption_rate" name="print_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="print_consumption_cost" name="print_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="eyelet_consumption_rate" name="eyelet_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="eyelet_consumption_cost" name="eyelet_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="buckle_consumption_rate" name="buckle_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="buckle_consumption_cost" name="buckle_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="snap_button_consumption_rate" name="snap_button_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="snap_button_consumption_cost" name="snap_button_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="magnetic_button_consumption_rate" name="magnetic_button_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="magnetic_button_consumption_cost" name="magnetic_button_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="bottom_base_consumption_rate" name="bottom_base_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="bottom_base_consumption_cost" name="bottom_base_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="thread_consumption_rate" name="thread_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="thread_consumption_cost" name="thread_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="tag_consumption_rate" name="tag_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="tag_consumption_cost" name="tag_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="label_consumption_rate" name="label_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="label_consumption_cost" name="label_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="packing_consumption_rate" name="packing_consumption_rate"  readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="packing_consumption_cost" name="packing_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="extra_1_piece_consumption_rate" name="extra_1_piece_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="extra_1_piece_consumption_cost" name="extra_1_piece_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="extra_2_piece_consumption_rate" name="extra_2_piece_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="extra_2_piece_consumption_cost" name="extra_2_piece_consumption_cost" readonly="readonly"></td>
                                </tr>
                                ...
                                <tr class="info">
                                    ...
                                    <td><input type="text" class="form-control" id="extra_3_piece_consumption_rate" name="extra_3_piece_consumption_rate" readonly="readonly"></td>
                                    <td>Piece</td>
                                    <td><input type="text" class="form-control" id="extra_3_piece_consumption_cost" name="extra_3_piece_consumption_cost" readonly="readonly"></td>
                                </tr>
                                </tbody>
