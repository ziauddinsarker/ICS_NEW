                    ...
                    <div class="part1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="order_company" id="order_company" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="order_item_name" id="order_item_name"  required>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="order_company"> Reference No:</label>
                                <input type="text" class="form-control" name="order_ref_no" id="order_ref_no" required>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
