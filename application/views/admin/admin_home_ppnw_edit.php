            ...
            <div class="part1">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="order_company" id="order_company" value="<?php echo $order_company ?>" required>
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="order_item_name" id="order_item_name"  value="<?php echo $order_item_name ?>" required>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="order_company"> Reference No:</label>
                        <input type="text" class="form-control" name="order_ref_no" id="order_ref_no" value="<?php echo $order_ref_no ?>" required>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="order_date"> Date:</label>
                        <input type="text" class="form-control" name="order_date" id="order_date" value="<?php echo $order_date ?>" required>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="order_gsm" name="order_gsm" value="<?php echo $order_gsm ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="order_colour" name="order_colour" value="<?php echo $order_colour ?>">
                            </div>
                            <br>

                            <div class="form-group">
                                <label for="order_usd" class="small-label"> USD:</label>
                                <input type="text" class="form-control" id="order_usd" name="order_usd" value="<?php echo $order_usd ?>" required>
                            </div>


                            <div class="form-group">
                                <label for="order_wastage" class="small-label">Wastage:</label>
                                <input type="text" class="form-control" id="order_wastage" name="order_wastage" value="<?php echo $order_wastage ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="order_margin" name="order_margin" value="<?php echo $order_margin ?>" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="order_quantity" name="order_quantity" value="<?php echo $order_quantity ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="order_transport" class="small-label"> Transport:</label>
                                <input type="text" class="form-control" id="order_transport" name="order_transport" value="<?php echo $order_transport ?>"> Tk/Truck
                            </div>
                            <br>

                            <div class="form-group">
                                <label for="order_bank_document">Bank & Document Charge:</label>
                                <input type="text" class="form-control" id="order_bank_document"  name="order_bank_document" value="<?php echo $order_bank_document ?>">Tk/Shipment
                            </div>
                            <br>
                    ...
                    <div class="part3">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_body_h" name="order_body_h" value="<?php echo $order_body_h ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_body_h_allowance" name="order_body_h_allowance" value="<?php echo $order_body_h_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_body_w" name="order_body_w" value="<?php echo $order_body_w ?>" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_body_w_allowance" name="order_body_w_allowance" value="<?php echo $order_body_w_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_body_panel" name="order_body_panel" value="<?php echo $order_body_panel ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_body_panel_allowance" name="order_body_panel_allowance" value="<?php echo $order_body_panel_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_handle_l" name="order_handle_l" value="<?php echo $order_handle_l ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_handle_l_allowance" name="order_handle_l_allowance" value="<?php echo $order_handle_l_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_handle_w" name="order_handle_w" value="<?php echo $order_handle_w ?>" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_handle_w_allowance" name="order_handle_w_allowance" value="<?php echo $order_handle_w_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="order_body">L:</label>
                                    <input type="text" class="form-control" id="order_pocket_l" name="order_pocket_l" value="<?php echo $order_pocket_l ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_pocket_l_allowance" name="order_pocket_l_allowance" value="<?php echo $order_pocket_l_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="order_body">W:</label>
                                    <input type="text" class="form-control" id="order_pocket_w" name="order_pocket_w" value="<?php echo $order_pocket_w ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_pocket_w_allowance" name="order_pocket_w_allowance"  value="<?php echo $order_pocket_w_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="order_body">L:</label>
                                    <input type="text" class="form-control" id="order_extra_1_l" name="order_extra_1_l" value="<?php echo $order_extra_1_l ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_extra_1_l_allowance" name="order_extra_1_l_allowance" value="<?php echo $order_extra_1_l_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="order_body">W:</label>
                                    <input type="text" class="form-control" id="order_extra_1_w" name="order_extra_1_w" value="<?php echo $order_extra_1_w ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_extra_1_w_allowance" name="order_extra_1_w_allowance" value="<?php echo $order_extra_1_w_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="order_body">L:</label>
                                    <input type="text" class="form-control" id="order_extra_2_l" name="order_extra_2_l" value="<?php echo $order_extra_2_l ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_extra_2_l_allowance" name="order_extra_2_l_allowance" value="<?php echo $order_extra_2_l_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="order_body">W:</label>
                                    <input type="text" class="form-control" id="order_extra_2_w" name="order_extra_2_w" value="<?php echo $order_extra_2_w ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_extra_2_w_allowance" name="order_extra_2_w_allowance" value="<?php echo $order_extra_2_w_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="order_body">L:</label>
                                    <input type="text" class="form-control" id="order_extra_3_l" name="order_extra_3_l" value="<?php echo $order_extra_3_l ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_extra_3_l_allowance" name="order_extra_3_l_allowance" value="<?php echo $order_extra_3_l_allowance ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="order_body">W:</label>
                                    <input type="text" class="form-control" id="order_extra_3_w" name="order_extra_3_w" value="<?php echo $order_extra_3_w ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="order_body">Allowance:</label>
                                    <input type="text" class="form-control" id="order_extra_3_w_allowance" name="order_extra_3_w_allowance" value="<?php echo $order_extra_3_w_allowance ?>">
                                </div>
                            </div>
